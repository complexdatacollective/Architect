...
window.electronAPI = {
  ...
  dialog: {
    showOpenDialog: vi.fn(() =>
      Promise.resolve({ canceled: false, filePaths: ['/fake/path'] }),
    ),
    showSaveDialog: vi.fn(() =>
      Promise.resolve({ canceled: false, filePath: '/fake/path.netcanvas' }),
    ),
...
vi.mock('@codaco/ui', async () => {
  ...
  return {
    ...
    GraphicButton: ({ children, ...props }) =>
      React.createElement('button', { type: 'button', ...props }, children),
    Node: ({ children, ...props }) =>
      React.createElement('div', { className: 'node', ...props }, children),
    ...
    Scroller: ({ children }) =>
      React.createElement('div', { className: 'scroller' }, children),
    ToastManager: ({ children }) =>
      React.createElement('div', { className: 'toast-manager' }, children),
  };
});
