...
const AssetBrowserScreen = ({ layoutId, onComplete }) => {
  const buttons = [
      ...
      >
        <div className="stage-heading stage-heading--inline">
          <Layout>
            ...
            <p>
              Welcome to the resource library. Here, you can import external
              data resources which can be used in building your protocol. These
              resources might include images, video, audio, or even external
              network data. See our{' '}
