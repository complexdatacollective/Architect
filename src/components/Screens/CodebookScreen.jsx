...
const CodebookScreen = (props) => {
  const { layoutId, onComplete } = props;
      ...
      >
        <div className="stage-heading stage-heading--inline">
          <Layout>
            ...
            <p>
              Below you can find an overview of the node and edge types that you
              have defined while creating your interview. Entities that are
