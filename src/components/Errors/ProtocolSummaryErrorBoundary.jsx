        ...
        <div className="error">
          <div className="error__layout">
            <h1 className="error__title">
              There was an error creating the protocol summary.
            </h1>
            ...
            <p>
              Please help us to find and fix this error by contacting the
              Network Canvas team and providing the text above.
            </p>
