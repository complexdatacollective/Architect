              ...
              <ul>
                <li>
                  ...
                  <ul>
                    ...
                    <li>Long term resolution: Block body scrolling or adjust select
                      children position relative to body scroll
                      (<ExternalLink href="https://github.com/complexdatacollective/Architect/issues/155">#155</ExternalLink>)</li>
                  </ul>
                </li>
              </ul>
