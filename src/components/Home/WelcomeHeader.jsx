...
const WelcomeHeader = () => {
  ...
  const downloadSampleProtocol = () =>
    dispatch(userActions.importSampleProtocol());
            ...
            >
              <Group className="home-welcome">
                <div className="home-welcome__content">
                  ...
                  <p>
                    Architect is a tool for building Network Canvas interviews.
                    To learn more about the software, and how to use it, please
                    visit the documentation website.
                  </p>
                  <p>
                    If you encounter any issues, or have any questions, please
                    visit our user community, where we will be happy to help.
                  </p>
                  <div className="welcome-actions">
                    <Button
                      ...
                      color="cerulean-blue"
                      onClick={() =>
                        openExternalLink('https://community.networkcanvas.com')
                      }
                    >
                      Community Website
                    </Button>
