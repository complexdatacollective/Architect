...
const DisplayEdges = ({ form, entity, type }) => {
  ...
  const edgesForSubject = useSelector((state) =>
    getEdgesForSubject(state, { entity, type }),
  );
  const createEdge = useSelector((state) =>
    formValueSelector(form)(state, 'edges.create'),
  );
  const displayEdges = useSelector((state) =>
    formValueSelector(form)(state, 'edges.display'),
  );
