...
const PromptFields = ({ form, entity, type }) => {
  ...
  const hasAdditionalAttributes = useSelector((state) =>
    getFormValue(state, 'additionalAttributes'),
  );
    ...
    <>
      ...
      >
        <Row>
          <Tip>
            <p>
              Select an existing variable, or select &quot;create new
              variable&quot; from the bottom of the list, and then assign a
              value. You can set different values for this variable for nodes
              created on different prompts.
            </p>
          </Tip>
          <AssignAttributes
