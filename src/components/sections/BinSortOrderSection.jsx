...
const BinSortOrderSection = ({
  ...
  const hasBinSortOrder = useSelector((state) =>
...
BinSortOrderSection.defaultProps = {
  ...
  summary: (
    <p>
      You may also configure one or more sort rules that determine the order
      that nodes are listed after they have been placed into a bin.
    </p>
  ),
};
