...
const PromptFields = ({
  ...
  <>
    ...
    <Section
      ...
      summary={
        <p>
          Enter question for the participant. e.g. What is this person&apos;s
          name?
        </p>
      }
    >
    ...
    {isOrdinalOrCategoricalType(variableType) && (
      <Section
        ...
        summary={
          <p>
            The input type you selected indicates that this is a categorical or
            ordinal variable. Next, please create a minimum of two possible
